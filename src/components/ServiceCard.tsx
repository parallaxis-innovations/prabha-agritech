		...
		>
			<Link href={href} className="block">
				...
				<div className="p-6">
					...
					{/* Arrow */}
					<div className="mt-4 flex items-center justify-start text-earth-green font-medium text-sm group-hover:gap-2 transition-all">
						...
						<svg
							...
							stroke="currentColor"
							strokeWidth="2"
							viewBox="0 0 24 24" // Added viewBox for better SVG scaling
						>
